...
**🎮 CLASSE:** Desenvolvedor de Sistemas <br>
**📍 SERVIDOR:** Hortolândia, SP — Etec <br>
...
Um dev em formação, treinando em HTML, CSS, JS,
Python, C#, MySQL e React. Fã de jogos de RNG e
progressão (grind é vida), joga basquete, é MC em
batalhas de freestyle e tem um carinho especial
por Pokémon.

Reconstruindo o perfil GitHub do zero — o save
anterior foi deletado, essa é a nova run. 🔄
```

**🏆 MISSÃO ATUAL:** Zerar o curso técnico e lançar os primeiros projetos reais no GitHub.
...
| ![JavaScript](https://img.shields.io/badge/JavaScript-1a1023?style=for-the-badge&logo=javascript&logoColor=F7DF1E) | ![MySQL](https://img.shields.io/badge/MySQL-1a1023?style=for-the-badge&logo=mysql&logoColor=4479A1) | ![Git](https://img.shields.io/badge/Git-1a1023?style=for-the-badge&logo=git&logoColor=F05032) |
| ![React](https://img.shields.io/badge/React-1a1023?style=for-the-badge&logo=react&logoColor=61DAFB) | | ![GitHub](https://img.shields.io/badge/GitHub-1a1023?style=for-the-badge&logo=github&logoColor=ffffff) |
...
#### 🟧 Quest: Scoreboard Manager
**Tipo:** Sistema de Gestão · MySQL
Cadastro de times e jogadores, registro de resultados e geração automática de tabela de classificação.
...
<img src="https://raw.githubusercontent.com/BrenoAfonso019/BrenoAfonso019/output/github-contribution-grid-snake-dark.svg"/>
